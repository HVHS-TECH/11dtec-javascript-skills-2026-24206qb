...
function showOutput(username, userAges, usermoney) {
  ...
  displayProduct("nokia 3310: ", "$65");
    ...
    if ( usermoney >= 65) {
    OUTPUT.innerHTML += "<p> A nokia 3310 costs $4, You CAN afford a nokia 3310 </p>";
  } else if ( usermoney <= 65 ) {
     OUTPUT.innerHTML += "<p> A nokia 3310 costs $4, Sorry you CAN'T afford a nokia 3310 </p>";
  }
